...
void _help()
{
    ...
    printf("Sample:/project/tools/bin/procctl 30 /project/tools/bin/ftpputfiles /log/idc/ftpputfiles_surfdata.log "\
              "\"<host>192.168.159.138:21</host><mode>1</mode><username>kk</username><password>123456</password>"\
              "<localpath>/tmp/idc/surfdata</localpath><remotepath>/tmp/ftpputest</remotepath>"\
    ...
    printf("<host>192.168.159.134:21</host> 远程服务端的IP和端口。\n");
    printf("<mode>1</mode> 传输模式，1-被动模式，2-主动模式，缺省采用被动模式。\n");
    printf("<username>kk</username> 远程服务端ftp的用户名。\n");
