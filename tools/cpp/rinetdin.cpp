...
int main(int argc,char *argv[])
{
    if (argc != 4)
    {
        ...
        printf("Sample:./rinetdin /tmp/rinetdin.log 192.168.159.138 5001\n\n");
        printf("        /project/tools/bin/procctl 5 /project/tools/bin/rinetdin /tmp/rinetdin.log 192.168.159.138 5001\n\n");
